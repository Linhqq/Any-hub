...
----------------------------------------------------------------------------------------------------------------------------------------------
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/EnverstNgau/GuiLibrary/main/MetMoi.lua"))()
local Win = Library:CreateWindow('            Cracked Trash Gui   ') 
local Tab  = Win:CreateTab('Main')
local TestL = Tab:Label("Aye On Top")
Tab:Button("Reset If Got Error","Reset By Destroy Your Head",function()
...
local L_4_ = L_1_:CreateWindow({
	Title = "Linhkhang Hub",
	SubTitle = "Make by Linhhand, TThe",
	TabWidth = 160,
...
---Close UI
	...
	L_92_.Parent = L_91_
	L_92_.BackgroundColor3 = Color3.fromRGB(30, 20, 20)
	L_92_.BackgroundTransparency = 1.000
	L_92_.BorderSizePixel = 0
	L_92_.Position = UDim2.new(0.120833337, 0, 0.0952890813, 0)
	L_92_.Size = UDim2.new(0, 60, 0, 60)
	L_92_.Image = "rbxassetid://16011933665"
